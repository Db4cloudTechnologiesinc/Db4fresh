...
=======
    <div className="bg-white rounded-2xl border border-gray-100 hover:shadow-lg transition duration-200 p-3 w-[210px] flex flex-col">
>>>>>>> 9014f7e7 (add kafka.js)
...
=======
          {/* DISCOUNT BADGE */}
          {discount > 0 && (
            <div className="absolute top-2 right-2 bg-red-500 text-white text-[10px] font-bold px-2 py-[3px] rounded-md">
              {discount}% OFF
>>>>>>> 9014f7e7 (add kafka.js)
            </div>
          )}
