...
//         <div ref={productsRef}>
//           {loadingProducts && (
//             <p className="text-gray-500 mb-3">Loading products...</p>
//           )}
...
export default function CategoryPage() {
  ...
  // ✅ DETECT COMING SOON
  const isComingSoon = String(id).startsWith("coming-soon");
  ...
  /* ================= LOAD CATEGORY ================= */
  useEffect(() => {
    if (isComingSoon) return; // ✅ SKIP API
  ...
  /* ================= COMING SOON UI ================= */
  if (isComingSoon) {
    const name = id.replace("coming-soon-", "").replace(/-/g, " ");
