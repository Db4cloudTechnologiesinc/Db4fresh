...
/* ================= DELIVERY ================= */
import DeliveryLogin from "../db4fresh_delivery/pages/DeliveryLogin";
import DeliveryDashboard from "../db4fresh_delivery/pages/DeliveryDashboard";
...
<Route path="/db4fresh_delivery" element={<Navigate to="/delivery/login" />} />
